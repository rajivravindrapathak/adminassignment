...
const AddTemplates = () => {
    ...
    const validateForm = () => {
        ...
        if (!name) {
            newError.name = "Template Name is required";
        }
                ...
                <Grid container spacing={2}>
                    <Grid item lg={12} sm={12} md={12} xs={12}>
                        <div className={classes.headingContainer}>
                            ...
                            <div onClick={() => navigate("/adminTemplates")} className={classes.addButton}>

                                <DvrIcon />
                                <div className={classes.addButtontext}>Display Admin Templates</div>
                            </div>
                        </div>
                    </Grid>
                    <Grid item lg={12} sm={12} md={12} xs={12} >
                    ...
                    <Grid item xs={12}>
                        <div style={{
                            ...
                            <h5 style={{ textAlign: "center" }}> Upload Templates</h5>
                        </div>
                    </Grid>
